...
class TestLoss(unittest.TestCase):
    ...
    def test_BCEfocal_loss(self):
        ...
        targets = torch.tensor([[0.], [1.], [1.], [0.]]).to(self.device)
    ...
    def test_CB_loss(self):
        ...
        criterian = ClassBalancedLoss(samples_per_cls=samples_per_class, beta = 0.2, num_classes=num_classes, loss_func=loss_fn)
